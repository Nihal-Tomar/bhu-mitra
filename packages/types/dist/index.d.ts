...
export declare const DEMO_MODE_LABEL: "DEMONSTRATION DATA \u2014 NOT REAL GOVERNMENT DATA";
export type RoleCode = 'SUPER_ADMIN' | 'CENTRAL_MINISTRY_ADMIN' | 'CENTRAL_MINISTRY_VIEWER' | 'STATE_NODAL_OFFICER' | 'DISTRICT_COLLECTOR' | 'LAND_ACQUISITION_OFFICER' | 'CALA' | 'REQUIRING_BODY_OFFICER' | 'COMPENSATION_OFFICER' | 'RR_OFFICER' | 'FIELD_OFFICER' | 'TEHSILDAR' | 'AUDITOR' | 'EXECUTIVE_VIEWER' | 'PUBLIC';
export type PermissionCode = 'project:create' | 'project:view' | 'project:update' | 'project:approve' | 'project:delete' | 'parcel:create' | 'parcel:view' | 'parcel:update' | 'workflow:view' | 'workflow:transition' | 'workflow:approve' | 'document:upload' | 'document:view' | 'document:download' | 'document:delete' | 'compensation:assess' | 'compensation:approve' | 'compensation:disburse' | 'compensation:view' | 'rehabilitation:manage' | 'rehabilitation:view' | 'possession:record' | 'possession:approve' | 'field:assign' | 'field:inspect' | 'field:view' | 'analytics:view-national' | 'analytics:view-state' | 'analytics:view-district' | 'report:export' | 'report:generate' | 'audit:view' | 'audit:export' | 'admin:users' | 'admin:roles' | 'public:view';
...
export type ProjectStage = 'SIA' | 'SEC_11_PRELIMINARY' | 'SEC_15_HEARING' | 'SEC_19_DECLARATION' | 'VALUATION' | 'SEC_23_AWARD' | 'COMPENSATION_DISBURSED' | 'R_AND_R' | 'SEC_38_POSSESSION' | 'COMPLETED';
...
export type LandCategory = 'Agricultural (Irrigated)' | 'Agricultural (Dry Crop)' | 'Commercial' | 'Residential' | 'Forest Land' | 'Community Gauchar' | 'Government Wasteland';
...
export interface WorkflowActionDto {
    ...
    title: string;
    description: string;
    actionType: 'SLA_BREACH_RESOLUTION' | 'GAZETTE_RESPONSE' | 'OBJECTION_HEARING' | 'VALUATION_APPROVAL' | 'DISBURSAL_MANDATE_HOLD' | 'POSSESSION_HANDOVER' | 'ENV_CLEARANCE';
...
export type GrievanceCategory = 'COMPENSATION_DISPUTE' | 'MEASUREMENT_ERROR' | 'OWNERSHIP_CLAIM' | 'R_AND_R_DENIAL' | 'DELAY_IN_PAYMENT' | 'PROCEDURAL_LAPSE';
...
export interface DocumentDto {
    id: string;
    title: string;
    documentType: 'GAZETTE_NOTIFICATION' | 'SIA_REPORT' | 'KHASRA_MAP' | 'VALUATION_CERTIFICATE' | 'AWARD_SHEET' | 'PAYMENT_RECEIPT' | 'FIELD_PHOTO';
    fileUrl: string;
    storageKey?: string;
    fileSize: number;
    mimeType: string;
